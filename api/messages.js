...
export default async function handler(req, res) {
  if (req.method === 'GET') {
    ...
    if (!user) return;
    // Se traen los últimos 100 mensajes (DESC + LIMIT) y se revierten en JS para
    // devolverlos en orden cronológico ascendente. Antes el ORDER BY era ASC, así que
    // el LIMIT 100 traía los 100 mensajes MÁS ANTIGUOS de toda la historia en vez de
    // los más recientes, y el chat dejaba de mostrar mensajes nuevos tras el #101.
